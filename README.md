...
Business Problem Explain your business problem

In order to improve the educational system, and make it much effective, one goal was to make the number of teachers and classes proportional to the number of students in a class. The targeted  number of students is 22 students per class by 2025. This can be achieved by analyzing the current state, identifying the number of schools with students more than the targeted number, and finally developing a plan for achieving the goal. 

 
Study Approach , the plots, your approach
...
This graph shows the number of students in each educational level distributed by provinces. It is clearly that elementary level has the highest number of students among all levels for all provinces, where it represents almost about 50% of each province's students. In contrast, kindergarten students has the least number of students in each province. Furthermore, high and middle school students are almost the same in each province.
 
Number of Students by Educational Level per Year

This graph shows the number of students yearly distributed by educational level. From the plot,  2021 has the highest number of students since 2018. the years 2018, 2019, and 2021 has almost the same number of students with a slight change either positive or negative and middle school students are almost the same in each province.
...
Total Students per Province by year

This bar plot represents the total number of students per province by year. In 2018 and 2021, the number of students is the highest for all provinces. Next the year of 2020 followed by 2019.

 
Total Classes per Year by Province
This bar plot represents the total number of classes per province by year. In 2018 and 2021, the number of classes is the highest for all provinces. Next the year of 2020 followed by 2019. This is clearly compatible with the number of student which was the highest in the years 2018 and 2021. 
...
Action Plan     what can be improved in detail.
